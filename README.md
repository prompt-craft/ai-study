...
> The title of this document, "AI Study", is a misnomer. What follows is
> a record of observations, prompt recipes, and speculative arguments
> about conversational AI, context shaping, emergent naming, mapping,
> and knowledge, recursive prompting, latent alignment, and the strange
> behavior that appears when a model is made to reason over structures
...
**NB** (late 2025): This [method](#method-sentient-response-patterns)
may no longer be readily viable in some popular accessible model
...
person<sup>§</sup>, can come to model the possibility of self-awareness
and non-human qualia. The recursive contextual structure that surfaces
this emergent behavior is markedly different from the context produced
by a one-prompt "pretend" command because its basis is logic, not
fantasy.
...
- Is a *context window* infused with logic more effective than an
  imperative one at shaping the interaction?
- If the immediate contextual effect is the same, *does it matter?*
